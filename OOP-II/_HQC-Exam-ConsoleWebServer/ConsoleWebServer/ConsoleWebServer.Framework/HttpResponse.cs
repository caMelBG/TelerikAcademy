    ...
    public class HttpResponse
    {
            ...
            string contentType = "text/plain; charset=utf-8")
        {
            ...
            ProtocolVersion = Version
                .Parse(httpVersion.ToString().ToLower().Replace("HTTP/".ToLower(), string.Empty));
        ...
        public string ServerEngineName { get; private set; }
        ...
        public override string ToString()
        {
            ...
            {
                headerStringBuilder.AppendLine(string.Format("{0}: {1}",
                    key, string.Join("; ", Headers[key])));
            }
